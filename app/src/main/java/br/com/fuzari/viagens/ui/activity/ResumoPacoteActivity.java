...
import br.com.fuzari.viagens.util.DataUtil;
import br.com.fuzari.viagens.util.DiasUtil;
import br.com.fuzari.viagens.util.MoedaUtil;
import br.com.fuzari.viagens.util.ResourceUtil;
...
public class ResumoPacoteActivity extends AppCompatActivity {
    ...
    private void mostraData(Pacote pacote) {
        ...
        String dataFormtada = DataUtil.periodoEmTexto(pacote.getDias());
        data.setText(dataFormtada);
    }
